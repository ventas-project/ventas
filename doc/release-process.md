...
space *do not upload these to the ventas.org server, nor put them in the torrent*.
...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the ventas.org server.

```

- Update ventas.org version

- Announce the release:

  - ventas-dev and ventas-dev mailing list

  - blog.ventas.org blog post
