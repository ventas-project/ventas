...
{
    const char* pszTimestamp = "To make Heni and Joowon’s life better";
    const CScript genesisOutputScript = CScript() << 
        ParseHex("0410f8a844fca86fd89dbdda789c908f29f63c523651ccb93190545a6eee1e11eabfa2c5491255edb6fddd6fc999b01d94d244913b6e1986a80149ca0d848e35db") << OP_CHECKSIG;
...
public:
    CMainParams() {
       ...
       // consensus.fPowAllowMinDifficultyBlocks = true;//set to min diff
        ...
        genesis = CreateGenesisBlock(1501545600,1235974, 0x1e0fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
       
        assert(consensus.hashGenesisBlock == uint256S("0x0b725bb68924f2d010c3b5d096d7ad0cfdf8be2b2ff1f3b71afeac4aed6f454b"));
        ...
        vSeeds.push_back(CDNSSeedData("seed1", "ven001.bitchk.com",true));
        vSeeds.push_back(CDNSSeedData("seed2", "ven002.bitchk.com",true));
        vSeeds.push_back(CDNSSeedData("seed3", "ven003.bitchk.com",true));
        vSeeds.push_back(CDNSSeedData("seed4", "ven004.bitchk.com",true));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  0, uint256S("0x64d1570a2a6fda935fddfab84100768f8c652f2e9cb905d9c6ef1568409519d4"))
        };

        chainTxData = ChainTxData{
            // Data as of block b44bc5ae41d1be67227ba9ad875d7268aa86c965b1d64b47c35be6e8d5c352f4 (height 1155626).
            1501545600, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
     ...
     //   consensus.fPowAllowMinDifficultyBlocks = true;
        ...
        genesis = CreateGenesisBlock(1501545605, 1177238, 0x1e0fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
     
        assert(consensus.hashGenesisBlock == uint256S("0x829d45a02ea1ecb6283e71f54c0c8026b8b4cd39efeae5a11e1cb7667d09d799"));
        assert(genesis.hashMerkleRoot == uint256S("0xa0b5a30e1c8faff26180cba6c9511ce58a72cf1e282e1121f18d9198b326dff5"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.push_back(CDNSSeedData("venta1", "ven001.bitchk.com",true));
...
public:
    CRegTestParams() {
     ...
     //   consensus.fPowAllowMinDifficultyBlocks = true;
        ...
        genesis = CreateGenesisBlock(1501545601, 508809, 0x1e0fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        
        assert(consensus.hashGenesisBlock == uint256S("0x70784725fcffeb40f13b7b67832c612722ee563290fc4ea72c290536662d3180"));
        assert(genesis.hashMerkleRoot == uint256S("0xec3411e81a522309829e0933569def13f6f7b45fafebfe96ccefb778fb7ef0c8"));
