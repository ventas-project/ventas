...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-a.ventas.loshan.co.uk", true));
...
public:
    CTestNetParams() {
        ...
        vSeeds.push_back(CDNSSeedData("ventastools.com", "testnet-seed.ventastools.com"));
        vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.ventas.loshan.co.uk", true));
