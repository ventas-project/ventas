...
const char * const BITCOIN_CONF_FILENAME = "ventas.conf";
const char * const BITCOIN_PID_FILENAME = "ventas.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Ventas";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Ventas";
#else
    // Unix
    return pathRet / ".ventas";
#endif
#endif
}
