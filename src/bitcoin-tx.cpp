...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s ventas-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  ventas-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ventas transaction") + "\n" +
              "  ventas-tx [options] -create [commands]   " + _("Create hex-encoded ventas transaction") + "\n" +
              "\n";
